//la siguiente resolusión es el resultado de seguir las instrucciones del readme paso a paso
//si estás haciendo eso y notás que el código no está quedando igual no te alarmes
//en el readme se detallan una serie de pasos para realizar el código de una manera (para entender que está pasando)
//y posteriormente se hace un refactoring para que  el código quede optimo y los test pasen.
//por ende te recomiendo seguir las instrucciones hasta el final antes de hecharle un vistazo a esta solución.
